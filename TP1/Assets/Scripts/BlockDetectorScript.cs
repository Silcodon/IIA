...
public class BlockDetectorScript : MonoBehaviour
{
    ...
    public float max_strength_linear;
    public float min_strength_linear;
    public float teta;
    public float mi;
    ...
    void FixedUpdate()
    {
        ...
        if (anObject != null)
        {
            ...
            strength = 1.0f / (anObject.distance + 1);
        }
        else
        { // no object detected
            strength = 0;
    ...
    {
        //META 2
        if (strength > max_strength_linear)
        {
            strength = min_strength_linear;
        }
        else if(strength < min_strength_linear)
        {
            strength = min_strength_linear;
        }
        return strength;
